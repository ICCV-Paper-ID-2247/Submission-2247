...
parser.add_argument('--lr_conprox', type=float, default=0.00001, help="learning rate for center loss") # as per paper
parser.add_argument('--weight-conprox', type=float, default=0.00001, help="weight for center loss") # as per paper
