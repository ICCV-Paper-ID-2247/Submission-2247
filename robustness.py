...
smodel = resnet(num_classes=num_classes,depth=110)
if True:
    smodel = nn.DataParallel(smodel).cuda()    

#Loading Trained Model
softmax_filename= 'Models_Softmax/CIFAR10_Softmax.pth.tar'    
filename= 'Models_PCL_AdvTrain_PGD/CIFAR10_PCL_AdvTrain_PGD_Epoch720.pth.tar'  
#filename= 'Models_PCL_AdvTrain_FGSM/CIFAR10_PCL_AdvTrain_FGSM_Epoch240.pth.tar'  
r_model= 'robust_model.pth.tar'
#s_checkpoint = torch.load(r_model)
#smodel.load_state_dict(s_checkpoint['state_dict'])
#smodel.eval()
